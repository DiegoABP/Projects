...
for i=1:5
for j=(i+1):5
  %Se escoge adam ya que es en la que mejor se observan los errores y asi tomar una decision
  method="adam";
  X=[X_comb(:,i) X_comb(:,j)];
...
printf("\n")
printf("Según el análisis anterior, se obtiene que los parámetros más importantes son el 2 y 3, en este caso seria el *culmen length* y *culmen depth*\n");
