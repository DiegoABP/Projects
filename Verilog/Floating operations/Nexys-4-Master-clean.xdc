...
set_property PACKAGE_PIN U9 [get_ports {ModoT[0]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {ModoT[0]}]
##Bank = 34, Pin name = IO_25_34,							Sch name = ResultadoT1
set_property PACKAGE_PIN U8 [get_ports {ResultadoT[1]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[1]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = ResultadoT2
set_property PACKAGE_PIN R7 [get_ports {ResultadoT[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[2]}]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = ResultadoT3
set_property PACKAGE_PIN R6 [get_ports {ResultadoT[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[3]}]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = ResultadoT4
set_property PACKAGE_PIN R5 [get_ports {ResultadoT[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[4]}]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = ResultadoT5
set_property PACKAGE_PIN V7 [get_ports {ResultadoT[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[5]}]
##Bank = 34, Pin name = IO_L20N_T3_34,						Sch name = ResultadoT6
set_property PACKAGE_PIN V6 [get_ports {ResultadoT[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[6]}]
##Bank = 34, Pin name = IO_L10P_T1_34,						Sch name = ResultadoT7
set_property PACKAGE_PIN V5 [get_ports {ResultadoT[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[7]}]
##Bank = 34, Pin name = IO_L8P_T1-34,						Sch name = ResultadoT8
set_property PACKAGE_PIN U4 [get_ports {ResultadoT[8]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[8]}]
##Bank = 34, Pin name = IO_L9N_T1_DQS_34,					Sch name = ResultadoT9
set_property PACKAGE_PIN V2 [get_ports {ResultadoT[9]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[9]}]
##Bank = 34, Pin name = IO_L9P_T1_DQS_34,					Sch name = ResultadoT10
set_property PACKAGE_PIN U2 [get_ports {ResultadoT[10]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[10]}]
##Bank = 34, Pin name = IO_L11N_T1_MRCC_34,					Sch name = ResultadoT11
set_property PACKAGE_PIN T3 [get_ports {ResultadoT[11]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[11]}]
##Bank = 34, Pin name = IO_L17N_T2_34,						Sch name = ResultadoT12
set_property PACKAGE_PIN T1 [get_ports {ResultadoT[12]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[12]}]
##Bank = 34, Pin name = IO_L11P_T1_SRCC_34,					Sch name = ResultadoT13
set_property PACKAGE_PIN R3 [get_ports {ResultadoT[13]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[13]}]
##Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = ResultadoT14
set_property PACKAGE_PIN P3 [get_ports {ResultadoT[14]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[14]}]
##Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = ResultadoT15
set_property PACKAGE_PIN P4 [get_ports {ResultadoT[15]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[15]}]
...
##Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = ResultadoT4
set_property PACKAGE_PIN T5 [get_ports {ResultadoT[16]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[16]}]
##Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = ResultadoT5
set_property PACKAGE_PIN T4 [get_ports {ResultadoT[17]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[17]}]
##Bank = 34, Pin name = IO_L22P_T3_34,						Sch name = ResultadoT6
set_property PACKAGE_PIN U7 [get_ports {ResultadoT[18]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[18]}]
##Bank = 34, Pin name = IO_L22N_T3_34,						Sch name = ResultadoT7
set_property PACKAGE_PIN U6 [get_ports {ResultadoT[19]}]					
set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[19]}]
##Bank = 34, Pin name = IO_L10N_T1_34,						Sch name = ResultadoT8
set_property PACKAGE_PIN V4 [get_ports {ResultadoT[20]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[20]}]
##Bank = 34, Pin name = IO_L8N_T1_34,						Sch name = ResultadoT9
set_property PACKAGE_PIN U3 [get_ports {ResultadoT[21]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[21]}]
##Bank = 34, Pin name = IO_L7N_T1_34,						Sch name = ResultadoT10
set_property PACKAGE_PIN V1 [get_ports {ResultadoT[22]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[22]}]
##Bank = 34, Pin name = IO_L17P_T2_34,						Sch name = ResultadoT11
set_property PACKAGE_PIN R1 [get_ports {ResultadoT[23]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[23]}]
##Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = ResultadoT12
set_property PACKAGE_PIN P5 [get_ports {ResultadoT[24]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[24]}]
##Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = ResultadoT13
set_property PACKAGE_PIN U1 [get_ports {ResultadoT[25]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[25]}]
##Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = ResultadoT14
set_property PACKAGE_PIN R2 [get_ports {ResultadoT[26]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[26]}]
##Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = ResultadoT15
set_property PACKAGE_PIN P2 [get_ports {ResultadoT[27]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[27]}]



##Bank = 34, Pin name = IO_L2N_T0_34,						Sch name = CA
set_property PACKAGE_PIN L3 [get_ports {ResultadoT[28]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[28]}]
##Bank = 34, Pin name = IO_L3N_T0_DQS_34,					Sch name = CB
set_property PACKAGE_PIN N1 [get_ports {ResultadoT[29]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[29]}]
##Bank = 34, Pin name = IO_L6N_T0_VREF_34,					Sch name = CC
set_property PACKAGE_PIN L5 [get_ports {ResultadoT[30]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[30]}]
##Bank = 34, Pin name = IO_L5N_T0_34,						Sch name = CD
set_property PACKAGE_PIN L4 [get_ports {ResultadoT[31]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[31]}]
...
set_property PACKAGE_PIN K3 [get_ports {AT[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[1]}]
##Bank = 34, Pin name = IO_L4N_T0_34,						Sch name = CF
set_property PACKAGE_PIN M2 [get_ports {AT[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[2]}]
##Bank = 34, Pin name = IO_L6P_T0_34,						Sch name = CG
set_property PACKAGE_PIN L6 [get_ports {AT[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[3]}]
...
set_property PACKAGE_PIN N6 [get_ports {AT[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[4]}]
##Bank = 34, Pin name = IO_L18P_T2_34,						Sch name = AN1
set_property PACKAGE_PIN M6 [get_ports {AT[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[5]}]
##Bank = 34, Pin name = IO_L4P_T0_34,						Sch name = AN2
set_property PACKAGE_PIN M3 [get_ports {AT[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[6]}]
##Bank = 34, Pin name = IO_L13_T2_MRCC_34,					Sch name = AN3
set_property PACKAGE_PIN N5 [get_ports {AT[7}]					
    set_property IOSTANDARD LVCMOS33 [get_ports {AT[7]}]
##Bank = 34, Pin name = IO_L3P_T0_DQS_34,					Sch name = AN4
set_property PACKAGE_PIN N2 [get_ports {AT[8]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[8]}]
##Bank = 34, Pin name = IO_L16N_T2_34,						Sch name = AN5
set_property PACKAGE_PIN N4 [get_ports {AT[9]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[9]}]
##Bank = 34, Pin name = IO_L1P_T0_34,						Sch name = AN6
set_property PACKAGE_PIN L1 [get_ports {AT[10]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[10]}]
##Bank = 34, Pin name = IO_L1N_T034,							Sch name = AN7
set_property PACKAGE_PIN M1 [get_ports {AT[11]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT11]}]



##Buttons
##Bank = 15, Pin name = IO_L3P_T0_DQS_AD1P_15,				Sch name = CPU_RESET
set_property PACKAGE_PIN C12 [get_ports BotonT]				
	set_property IOSTANDARD LVCMOS33 [get_ports BotonT]
...
##Pmod Header AT
##Bank = 15, Pin name = IO_L1N_T0_AD0N_15,					Sch name = AT1
set_property PACKAGE_PIN B13 [get_ports {AT[12]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[12]}]
##Bank = 15, Pin name = IO_L5N_T0_AD9N_15,					Sch name = AT2
set_property PACKAGE_PIN F14 [get_ports {AT[13]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[13]}]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = AT3
set_property PACKAGE_PIN D17 [get_ports {AT[14]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[14]}]
##Bank = 15, Pin name = IO_L16P_T2_A28_15,					Sch name = AT4
set_property PACKAGE_PIN E17 [get_ports {AT[15]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[15]}]
##Bank = 15, Pin name = IO_0_15,						Sch name = AT7
set_property PACKAGE_PIN G13 [get_ports {AT[16]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[16]}]
##Bank = 15, Pin name = IO_L20N_T3_A19_15,					Sch name = AT8
set_property PACKAGE_PIN C17 [get_ports {AT[17]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[17]}]
##Bank = 15, Pin name = IO_L21N_T3_A17_15,					Sch name = AT9
set_property PACKAGE_PIN D18 [get_ports {AT[18]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[18]}]
##Bank = 15, Pin name = IO_L21P_T3_DQS_15,					Sch name = AT10
set_property PACKAGE_PIN E18 [get_ports {AT[19]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[19]}]



Pmod Header AT
#Bank = 15, Pin name = IO_L15N_T2_DQS_ADV_B_15,				Sch name = AT1
set_property PACKAGE_PIN G14 [get_ports {AT[20]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[20]}]
##Bank = 14, Pin name = IO_L13P_T2_MRCC_14,					Sch name = AT2
set_property PACKAGE_PIN P15 [get_ports {AT[21]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[21]}]
##Bank = 14, Pin name = IO_L21N_T3_DQS_A06_D22_14,			Sch name = AT3
set_property PACKAGE_PIN V11 [get_ports {AT[22]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[22]}]
##Bank = CONFIG, Pin name = IO_L16P_T2_CSI_B_14,				Sch name = AT4
set_property PACKAGE_PIN V15 [get_ports {AT[23]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[23]}]
##Bank = 15, Pin name = IO_25_15,							Sch name = AT7
set_property PACKAGE_PIN K16 [get_ports {AT[24]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[24]}]
##Bank = CONFIG, Pin name = IO_L15P_T2_DQS_RWR_B_14,			Sch name = AT8
set_property PACKAGE_PIN R16 [get_ports {AT[25]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[25]}]
##Bank = 14, Pin name = IO_L24P_T3_A01_D17_14,				Sch name = AT9
set_property PACKAGE_PIN T9 [get_ports {AT[26]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[26]}]
##Bank = 14, Pin name = IO_L19N_T3_A09_D25_VREF_14,			Sch name = AT10 
set_property PACKAGE_PIN U11 [get_ports {AT[27]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[27]}]


##Pmod Header JC
##Bank = 35, Pin name = IO_L23P_T3_35,						Sch name = JC1
set_property PACKAGE_PIN K2 [get_ports {AT[28]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[28]}]
##Bank = 35, Pin name = IO_L6P_T0_35,						Sch name = JC2
set_property PACKAGE_PIN E7 [get_ports {AT[29]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[29]}]
##Bank = 35, Pin name = IO_L22P_T3_35,						Sch name = JC3
set_property PACKAGE_PIN J3 [get_ports {AT[30]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[30]}]
##Bank = 35, Pin name = IO_L21P_T3_DQS_35,					Sch name = JC4
set_property PACKAGE_PIN J4 [get_ports {AT[31]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[31]}]
##Bank = 35, Pin name = IO_L23N_T3_35,						Sch name = JC7
set_property PACKAGE_PIN K1 [get_ports {AT[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {AT[0]}]
##Bank = 35, Pin name = IO_L5P_T0_AD13P_35,					Sch name = JC8
set_property PACKAGE_PIN E6 [get_ports {ResultadoT[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {ResultadoT[0]}]
...
##Pmod Header BT
##Bank = 35, Pin name = IO_L21N_T2_DQS_35,					Sch name = BT1
set_property PACKAGE_PIN H4 [get_ports {BT[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {BT[0]}]
##Bank = 35, Pin name = IO_L17P_T2_35,						Sch name = BT2
set_property PACKAGE_PIN H1 [get_ports {BT[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {BT[1]}]
##Bank = 35, Pin name = IO_L17N_T2_35,						Sch name = BT3
set_property PACKAGE_PIN G1 [get_ports {BT[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {BT[2]}]
##Bank = 35, Pin name = IO_L20N_T3_35,						Sch name = BT4
set_property PACKAGE_PIN G3 [get_ports {BT[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {BT[3]}]
##Bank = 35, Pin name = IO_L15P_T2_DQS_35,					Sch name = BT7
set_property PACKAGE_PIN H2 [get_ports {BT[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {BT[4]}]
##Bank = 35, Pin name = IO_L20P_T3_35,						Sch name = BT8
set_property PACKAGE_PIN G4 [get_ports {BT[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {BT[5]}]
##Bank = 35, Pin name = IO_L15N_T2_DQS_35,					Sch name = BT9
set_property PACKAGE_PIN G2 [get_ports {BT[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {BT[6]}]
##Bank = 35, Pin name = IO_L13N_T2_MRCC_35,					Sch name = BT10
set_property PACKAGE_PIN F3 [get_ports {BT[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {BT[7]}]
 

##Pmod Header BT
##Bank = 15, Pin name = IO_L9P_T1_DQS_AD3P_15,				Sch name = XADC1_P -> XA1_P
set_property PACKAGE_PIN A13 [get_ports {BT[8]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {BT[8]}]
##Bank = 15, Pin name = IO_L8P_T1_AD10P_15,					Sch name = XADC2_P -> XA2_P
set_property PACKAGE_PIN A15 [get_ports {BT[9]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {BT[9]}]
##Bank = 15, Pin name = IO_L7P_T1_AD2P_15,					Sch name = XADC3_P -> XA3_P
set_property PACKAGE_PIN B16 [get_ports {BT[10]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {BT[10]}]
##Bank = 15, Pin name = IO_L10P_T1_AD11P_15,					Sch name = XADC4_P -> XA4_P
set_property PACKAGE_PIN B18 [get_ports {BT[11]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {BT[11]}]
##Bank = 15, Pin name = IO_L9N_T1_DQS_AD3N_15,				Sch name = XADC1_N -> XA1_N
set_property PACKAGE_PIN A14 [get_ports {BT[12]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {BT[12]}]
##Bank = 15, Pin name = IO_L8N_T1_AD10N_15,					Sch name = XADC2_N -> XA2_N
set_property PACKAGE_PIN A16 [get_ports {BT[13]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {BT[13]}]
##Bank = 15, Pin name = IO_L7N_T1_AD2N_15,					Sch name = XADC3_N -> XA3_N 
set_property PACKAGE_PIN B17 [get_ports {BT[14]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {BT[14]}]
##Bank = 15, Pin name = IO_L10N_T1_AD11N_15,					Sch name = XADC4_N -> XA4_N
set_property PACKAGE_PIN A18 [get_ports {BT[14]}]				
	set_property IOSTANDARD LVCMOS33 [get_ports {BT[14]}]


##VGA Connector
##Bank = 35, Pin name = IO_L8N_T1_AD14N_35,					Sch name = VGA_R0
set_property PACKAGE_PIN A3 [get_ports {BT[15]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {BT[15]}]
##Bank = 35, Pin name = IO_L7N_T1_AD6N_35,					Sch name = VGA_R1
set_property PACKAGE_PIN B4 [get_ports {BT[16]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {BT[16]}]
##Bank = 35, Pin name = IO_L1N_T0_AD4N_35,					Sch name = VGA_R2
set_property PACKAGE_PIN C5 [get_ports {BT[17]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {BT[17]}]
##Bank = 35, Pin name = IO_L8P_T1_AD14P_35,					Sch name = VGA_R3
set_property PACKAGE_PIN A4 [get_ports {BT[18]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {BT[18]}]
##Bank = 35, Pin name = IO_L2P_T0_AD12P_35,					Sch name = VGA_B0
set_property PACKAGE_PIN B7 [get_ports {BT[19]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {BT[19]}]
##Bank = 35, Pin name = IO_L4N_T0_35,						Sch name = VGA_B1
set_property PACKAGE_PIN C7 [get_ports {BT[20]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {BT[20]}]
##Bank = 35, Pin name = IO_L6N_T0_VREF_35,					Sch name = VGA_B2
set_property PACKAGE_PIN D7 [get_ports {BT[21]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {BT[21]}]
##Bank = 35, Pin name = IO_L4P_T0_35,						Sch name = VGA_B3
set_property PACKAGE_PIN D8 [get_ports {BT[22]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {BT[22]}]
##Bank = 35, Pin name = IO_L1P_T0_AD4P_35,					Sch name = VGA_G0
set_property PACKAGE_PIN C6 [get_ports {BT[23]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {BT[23]}]
##Bank = 35, Pin name = IO_L3N_T0_DQS_AD5N_35,				Sch name = VGA_G1
set_property PACKAGE_PIN A5 [get_ports {BT[24]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {BT[24]}]
##Bank = 35, Pin name = IO_L2N_T0_AD12N_35,					Sch name = VGA_G2
set_property PACKAGE_PIN B6 [get_ports {BT[25]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {BT[25]}]
##Bank = 35, Pin name = IO_L3P_T0_DQS_AD5P_35,				Sch name = VGA_G3
set_property PACKAGE_PIN A6 [get_ports {BT[26]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {BT[26]}]
##Bank = 15, Pin name = IO_L4P_T0_15,						Sch name = VGA_HS
set_property PACKAGE_PIN B11 [get_ports{BT[27]}]						
set_property IOSTANDARD LVCMOS33 [get_ports {BT[27]}]
#Bank = 15, Pin name = IO_L3N_T0_DQS_AD1N_15,				Sch name = VGA_VS
set_property PACKAGE_PIN B12 [get_ports {BT[28]}]						
set_property IOSTANDARD LVCMOS33 [get_ports {BT[28]}]
...
set_property PACKAGE_PIN E2 [get_ports {BT[29]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {BT[29]}]
##Bank = 35, Pin name = IO_L9N_T1_DQS_AD7N_35,				Sch name = SD_CD
set_property PACKAGE_PIN A1 [get_ports {BT[30]}]						
set_property IOSTANDARD LVCMOS33 [get_ports {BT[30]}]
##Bank = 35, Pin name = IO_L9P_T1_DQS_AD7P_35,				Sch name = SD_SCK
set_property PACKAGE_PIN B1 [get_ports {BT[31]]						
	set_property IOSTANDARD LVCMOS33 [get_ports {BT[31]]
